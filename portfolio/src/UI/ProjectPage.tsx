            ...
            <div className="flex flex-col justify-end h-full p-5">
              ...
              <div>
                {lang.map((prog, index) => (
                  <span
                    key={index}
                    className="inline-block bg-gray-200 rounded-md border-2 border-gray-500 px-3 py-1 text-sm font-semibold text-gray-700 mr-2 dark:bg-gray-700 dark:text-gray-200"
                  >
                    {prog}
                  </span>
                ))}
